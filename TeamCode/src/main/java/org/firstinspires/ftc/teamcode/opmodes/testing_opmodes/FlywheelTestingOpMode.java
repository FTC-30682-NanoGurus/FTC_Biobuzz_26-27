...
/**
 * Bench opmode for tuning a FIXED (non-turret) flywheel shooter, with field-centric driving and the
 * intake rollers available so the whole shot cycle can be exercised for real.
 *
 ...
 * <h2>CONTROLS</h2>
 * <pre>
 * GAMEPAD 1 - DRIVING (field centric, arcade; same as driveTesting)
 *   Left stick X / Y .... strafe / forward
 *   Right stick X ....... turn
 *   Left bumper (hold) .. precision      Right bumper (hold) .. override
 *   Y / X / A ........... toggle field centric / heading hold / translation hold
 *   Back or Options ..... reset the heading reference
 *
 ...
 */
@Config
@TeleOp(name = "Flywheel Testing", group = "tuning")
public class FlywheelTestingOpMode extends LinearOpMode {
    ...
    public static double START_KI = 0.015;
    public static double START_KD = 0.0001;
    public static double START_KF = 0.000426;
    ...
    // =============================================================================================
    // Drive - fields copied from driveTesting
    // =============================================================================================
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // ---- DRIVE SETUP - same as driveTesting -------------------------------------------------
        ...
        // Field centric on by default, exactly as driveTesting does it. The rotation lives in
        // MecaTank.smoothDriveCore() and is not duplicated here.
        ...
        telemetry.addLine("FLYWHEEL TESTING");
        telemetry.addLine("gp1 = drive (field centric arcade)");
        ...
        while (!isStopRequested() && opModeIsActive()) {
            ...
            if (sendTelemetry) {
                ...
                telemetry.addData("Heading (deg)", "%.1f",
                        Math.toDegrees(mecaTank.getPoseEstimate().heading.toDouble()));
